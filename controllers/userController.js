...
exports.login = BigPromise(async (req, res, next) => {
    ...
    if (!user) {
        return next(new CustomError('You are not a registered user please register before login', 400))
    }
...
exports.updateUserDetails = BigPromise(async (req, res, next) => {
  ...
  if (!name || !email) {
    return next(new CustomError("please provide name and email to modify", 400));
  }
